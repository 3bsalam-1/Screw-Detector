...
class SAHIPredictor:
    ...
    def predict_batch(self, images: list[Union[str, Path]], **kwargs) -> dict[str, list[dict]]:
        """
    ...
    def benchmark(
        self, image_path: Union[str, Path], num_runs: int = 10, **kwargs
    ) -> dict[str, float]:
        """
...
def calculate_slice_count(
    image_width: int, image_height: int, slice_size: int = 640, overlap: int = 128
) -> tuple[int, int]:
    """
