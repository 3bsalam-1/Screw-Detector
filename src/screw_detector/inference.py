...
class BaselineInference:
    ...
    def __init__(
        self, model_path: Union[str, Path], confidence_threshold: float = 0.5, device: str = "cpu"
    ):
        """
    ...
    def predict(self, image_path: Union[str, Path], imgsz: int = 640, **kwargs) -> list[dict]:
        """
    ...
    def predict_batch(
        self, image_paths: list[Union[str, Path]], imgsz: int = 640, **kwargs
    ) -> dict[str, list[dict]]:
        """
...
class SAHIInference:
    ...
    def __init__(
        self, model_path: Union[str, Path], config: Optional[SAHIConfig] = None, device: str = "cpu"
    ):
        """
    ...
    def predict_batch(self, image_paths: list[Union[str, Path]], **kwargs) -> dict[str, list[dict]]:
        """
...
def compare_inference(
    ...
    return {"baseline": baseline.predict(image_path), "sahi": sahi.predict(image_path)}
