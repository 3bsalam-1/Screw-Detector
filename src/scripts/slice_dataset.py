...
from screw_detector.dataset import (  # noqa: E402
    DatasetStats,
...
def parse_args():
    ...
    # Slicing arguments
    parser.add_argument("--slice-size", type=int, default=640, help="Size of each slice (square)")
    parser.add_argument(
        "--overlap", type=int, default=128, help="Overlap between adjacent slices in pixels"
    )
    parser.add_argument(
    ...
    parser.add_argument("--validate", action="store_true", help="Validate dataset before slicing")
...
def main():
    ...
    print("   python -m src.scripts.train --data data/configs/sliced_data.yaml --sliced-data")
    print("=" * 60)
