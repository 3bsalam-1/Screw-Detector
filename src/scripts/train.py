...
from screw_detector.config import TrainingConfig
...
def parse_args():
    ...
    parser.add_argument(
        "--sliced-data", action="store_true", help="Use sliced dataset for training"
    )
    ...
    # Output arguments
    parser.add_argument(
        "--project", type=str, default="results", help="Project directory for results"
    )
    parser.add_argument("--name", type=str, default="train_baseline", help="Experiment name")
    ...
    parser.add_argument(
        "--stats", action="store_true", help="Show dataset statistics before training"
    )
