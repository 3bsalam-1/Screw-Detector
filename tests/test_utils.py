...
class TestCalculateSizeBasedRecall:
    ...
    def test_size_based_recall(self):
        ...
        for _size_bin, stats in results.items():
...
class TestGetImageSize:
    ...
    @pytest.mark.skipif(not Path("data/raw/test/images").exists(), reason="Test images not found")
...
class TestLoadGroundTruth:
    ...
    @pytest.mark.skipif(not Path("data/raw/test/labels").exists(), reason="Test labels not found")
